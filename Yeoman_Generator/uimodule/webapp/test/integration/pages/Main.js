sap.ui.require([
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "ui5.ui5conceptsproject.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of ui5.ui5conceptsproject"
                        },
                        success: function() {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title ui5.ui5conceptsproject"
                    });
                }
            }
