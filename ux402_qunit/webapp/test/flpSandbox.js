		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Unit Tests",
									"targetURL": "#student27comsaptrainingux402qunitux402qunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student27comsaptrainingux402qunitux402qunit-display": {
								"semanticObject": "student27comsaptrainingux402qunitux402qunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student27.com.sap.training.ux402.qunit.ux402qunit",
									"url": sap.ui.require.toUrl("student27/com/sap/training/ux402/qunit/ux402qunit")
								}
							}
						}
					}
