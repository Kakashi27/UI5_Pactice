		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#student27comsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student27comsaptrainingux402opaux402opa-display": {
								"semanticObject": "student27comsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student27.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student27/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
